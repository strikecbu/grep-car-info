        ...
        <section className="p-6 dark:bg-gray-800 dark:text-gray-100">
            <div className="container p-4 mx-auto text-center text-white">
                <h2 className="text-4xl font-bold">
                    Use the industry leaders solutions
                </h2>
            </div>
            <div className="container flex flex-wrap justify-center mx-auto dark:text-gray-400 items-center">
                ...
                <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                    ...
                    {/*</svg>*/}
                    <img className="w-40" src="/spring-boot-logo.png" alt="" />
                </div>
                <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                    <img className="w-28" src="/kafka-logo.png" alt="" />
                </div>
            </div>
        </section>
    )
